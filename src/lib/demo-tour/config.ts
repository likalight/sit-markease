...
export const TOUR_STEPS: Record<TourMode, TourStep[]> = {
  formative: [
    ...
    },
    {
      ...
      body: "No instructor was involved in releasing this — that's the whole point of formative practice. Ready to turn this gap into more practice?",
      advanceOn: "click-target",
    },
    {
      role: "student",
    ...
    },
    {
      ...
      body: "Rubric, to submission, to release, to a fresh targeted practice question — end to end, no shortcuts.",
      advanceOn: "button",
      end: true,
    },
  ],
  summative: [
    ...
    },
    {
      ...
      matches: (p) => p.startsWith("/feedback"),
      targetTourId: "exam-prep-link",
      title: "That's the review-and-release loop",
      body: "Instructor-reviewed, then released — nothing skips that gate. Ready to turn this into more practice?",
      advanceOn: "click-target",
    },
    {
      role: "student",
    ...
    },
    {
      ...
      targetTourId: "practice-page-body",
      title: "That's the whole loop",
      body: "Rubric, to script, to review, to release, to a fresh targeted practice question — end to end, no shortcuts.",
      advanceOn: "button",
      end: true,
    },
  ],
